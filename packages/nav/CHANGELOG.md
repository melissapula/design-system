...
- c6a5e40: **Actually** fix the invisible hamburger icon. The previous two patches (color cascade, then explicit color override + filled rects) addressed real concerns but missed the root cause:
