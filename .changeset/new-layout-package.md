---
'@mfp-design-system/layout': minor
---

New **`@mfp-design-system/layout`** package — Bootstrap-style layout primitives plus a spacing / flex / grid utility CSS sheet driven by the design system's spacing tokens.
