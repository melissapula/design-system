---
'@mfp-design-system/form-field': minor
---

Initial release of `@mfp-design-system/form-field` — `<mfp-form-field>` wrapper that adds label, hint, error, and required indicator around any control.
